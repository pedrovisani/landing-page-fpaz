        ...
        <div className={`${styles["products-container"]} flex-center wh-100`}>
          <div className={`${styles.products} wh-100 gap-20 pr`}>
            <div className={styles["products-content"]}>
              ...
              <button onClick={() => setProductTab("product-01")}>
                Saiba mais
              </button>
            </div>
            <div className={styles["products-content"]}>
              ...
              <button onClick={() => setProductTab("product-02")}>
                Saiba mais
              </button>
            </div>
            <div className={styles["products-content"]}>
              ...
              <p className={styles["product-description"]}>
                ...
                online. Ou seja, dinheiro rápido e sem comprometer a renda
                mensal
              </p>
              <button onClick={() => setProductTab("product-03")}>
                Saiba mais
              </button>
            </div>
            <div className={styles["products-content"]}>
            ...
            <div className={styles["products-content"]}>
              ...
              <p className={styles["product-description"]}>
                Aquisição de bens como carros, imóveis ou serviços, sem juros,
                por meio de sorteios ou lances em grupos. Também, é possível
                adquirir cotas contempladas
              </p>
              <button onClick={() => setProductTab("product-05")}>
                Saiba mais
              </button>
            </div>
            <div className={styles["products-content"]}>
              ...
              <button onClick={() => setProductTab("product-06")}>
                Saiba mais
              </button>
            </div>
          </div>
